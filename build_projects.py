...
BLOCKLIST = ["brandon wellacruz", "brandon wellacruz", "wellacruz", "captain brandon"]
...
(function(){
  document.querySelectorAll('.slides[data-slides]').forEach(function(box){
    ...
    box.querySelector('.prev').addEventListener('click',function(){go(i-1)});
    box.querySelector('.next').addEventListener('click',function(){go(i+1)});
