...
@media (max-width:560px){
  ...
  .slide img{aspect-ratio:4/5;object-position:left top}/* 390px: tall crop anchors
     top-LEFT, not top-center — dashboard/product screenshots read from their
     nav + main column instead of being sliced mid-word on both edges */
